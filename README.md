...
This BFF component can be deployed to the IBM Cloud using a Bluemix Toolchain (**work in progress**). Any required services will be automatically provisioned, once, during the deployment stage of the component.
